...
tile_name=$6
app="$7/dogDescriptor/dogDescriptor"
MCRROOT=$8
...
${app} ${mcr} ${input_file1} ${output_file1} "[11 11 11]" "[3.405500 3.405500 3.405500]" "[4.049845 4.049845 4.049845]" "[5 1019 5 1531 5 250]" 4

${app} ${mcr} ${input_file2} ${output_file2} "[11 11 11]" "[3.405500 3.405500 3.405500]" "[4.049845 4.049845 4.049845]" "[5 1019 5 1531 5 250]" 4
